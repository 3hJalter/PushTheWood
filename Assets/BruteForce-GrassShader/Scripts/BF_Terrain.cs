...
public class BF_Terrain : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            UpdateTerrainData();
            if (isSynced && terrainToCopy != null &&
                terrainToCopy.terrainData.GetHeights(0, 0, terrainToCopy.terrainData.heightmapResolution,
                    terrainToCopy.terrainData.heightmapResolution) != terrainAsset.terrainData.GetHeights(0, 0,
                    terrainAsset.terrainData.heightmapResolution,
                    terrainAsset.terrainData.heightmapResolution)) CopyTerrainData();
        }
#endif
    }
    ...
    private void OnRenderObject()
    {
        ...
        {
            if (Selection.activeGameObject == gameObject && selectGO != gameObject)
            {
    ...
    private void StoreTerrainData()
    {
        if (terrainDataOld == null)
        {
            ...
            terrainHeightOld = terrainAsset.terrainData.GetHeights(0, 0, terrainAsset.terrainData.heightmapResolution,
                terrainAsset.terrainData.heightmapResolution);
    ...
    {
        terrainAsset = GetComponent<Terrain>();
        ...
        if (terrainData.terrainLayers.Length > 4)
        {
            ...
            grassTerrainMaterial.SetVector("_Splat4_STn",
                new Vector4(terrainData.terrainLayers[4].tileOffset.x, terrainData.terrainLayers[4].tileOffset.y,
                    terrainData.terrainLayers[4].tileSize.x, terrainData.terrainLayers[4].tileSize.y));
        ...
        if (terrainData.terrainLayers.Length > 5)
        {
            ...
            grassTerrainMaterial.SetVector("_Splat5_STn",
                new Vector4(terrainData.terrainLayers[5].tileOffset.x, terrainData.terrainLayers[5].tileOffset.y,
                    terrainData.terrainLayers[5].tileSize.x, terrainData.terrainLayers[5].tileSize.y));
        ...
        if (terrainData.terrainLayers.Length > 6)
        {
            ...
            grassTerrainMaterial.SetVector("_Splat6_STn",
                new Vector4(terrainData.terrainLayers[6].tileOffset.x, terrainData.terrainLayers[6].tileOffset.y,
                    terrainData.terrainLayers[6].tileSize.x, terrainData.terrainLayers[6].tileSize.y));
        ...
        if (terrainData.terrainLayers.Length > 7)
        {
            ...
            grassTerrainMaterial.SetVector("_Splat7_STn",
                new Vector4(terrainData.terrainLayers[7].tileOffset.x, terrainData.terrainLayers[7].tileOffset.y,
                    terrainData.terrainLayers[7].tileSize.x, terrainData.terrainLayers[7].tileSize.y));
    ...
    public void CopyTerrainData()
    {
        if (terrainToCopy != null && terrainToCopy != terrainAsset)
        {
            ...
            terrainAsset.terrainData.SetHeights(0, 0,
                terrainToCopy.terrainData.GetHeights(0, 0, terrainToCopy.terrainData.heightmapResolution,
                    terrainToCopy.terrainData.heightmapResolution));
