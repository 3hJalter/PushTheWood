...
public class BF_BallPlayerTriplanar : MonoBehaviour
{
    ...
    [HideInInspector] public Vector3 gravityCustom = Vector3.zero;
    ...
    private void MoveBall()
    {
        ...
        moveDirection = camRot * new Vector3(Mathf.Clamp(inputDirection.x * 2, -1, 1),
            Mathf.Clamp(inputDirection.z * 2, -1, 1), 0f);
    ...
    {
        gravityCustom = (planet.position - transform.position).normalized;
