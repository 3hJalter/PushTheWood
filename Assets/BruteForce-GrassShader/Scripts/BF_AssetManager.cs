...
public class BF_AssetManager : MonoBehaviour
{
    ...
    [HideInInspector] public UnityEvent m_ShowcaseChange = new();
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha1)) SwitchSubShowcase(-1);
        if (Input.GetKeyDown(KeyCode.Alpha2)) SwitchSubShowcase(1);
#else
    ...
    public void SwitchShowcase(int addIndex)
    {
        ...
        else if (showcaseIndex == maxIndex + 1) showcaseIndex = 0;
    ...
    public void SwitchSubShowcase(int addIndex)
    {
        ...
        else if (subShowcaseIndex == maxSubIndex + 1) subShowcaseIndex = 0;
        m_ShowcaseChange.Invoke();
