...
public static class Matrix4x4Extension
{
    ...
    public static Matrix4x4 GetOrthographicProjection(float left, float right, float bottom, float top, float near,
        float far)
    {
...
public static class CameraExtension
{
    ...
    public static Vector4 GetProjectionExtents(this Camera camera, float texelOffsetX, float texelOffsetY)
    {
        ...
        float oneExtentY = camera.orthographic
        ...
        return new Vector4(oneExtentX, oneExtentY, oneJitterX,
    ...
    public static Vector4 GetProjectionExtents(this Camera camera, Camera.StereoscopicEye eye, float texelOffsetX,
        float texelOffsetY)
    {
