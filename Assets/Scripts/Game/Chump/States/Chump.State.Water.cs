    ...
    public partial class Chump
    {
        public class ChumpWaterState : State
        {
            ...
            public override void Enter()
            {
                ...
                else
                {
                    ...
                    cell.Tree2.transform.DOMoveY(originHeight1 - 2.5f, 0.25f).OnComplete(() =>
                    {
                        ...
                        cell.Tree2.transform.DOMove(
                            new Vector3(cell.Tree2.transform.position.x, originHeight1,
                                cell.Tree2.transform.position.z + 0.5f), FLOAT_TIME);
                    });
                    ...
                    cell.Tree1.transform.DOMoveY(originHeight1 - 2.5f, 0.25f).OnComplete(() =>
                    {
                        ...
                        cell.Tree1.transform.DOMove(
                            new Vector3(cell.Tree1.transform.position.x, originHeight1,
                                cell.Tree1.transform.position.z - 0.5f), FLOAT_TIME);
            ...
            public override void Move(Vector3 dir)
            {
                ...
                if (nextCell.Value.type == CellType.Water && !nextCell.IsRaft && nextCell.Tree1 == null)
                {
                    isRaftMoving = true;
                    desCell = nextCell;
                }
