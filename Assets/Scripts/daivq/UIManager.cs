...
namespace Daivq
{
    ...
    public class UIManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _btnsNextLevel.onClick.AddListener(() => NextLevelButton(LevelManager.Inst.Land));
            SetTeleportPosition();
        ...
        {
            LevelManager.Inst.player.SetPosition(LevelManager.Inst.initPos[index]);
            WorldMapBack();
        }
        ...
        private void StartPlayFromMainMenu()
        {
            ...
            void StartPlay()
            {
                ...
                Tutorial.Inst.tapContinueButton.gameObject.SetActive(true);
            }
        }
        ...
        {
            LevelManager.Inst.Steps = 0;
            if (LevelManager.Inst.WinBySkip) return;
