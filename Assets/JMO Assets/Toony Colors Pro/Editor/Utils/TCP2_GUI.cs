...
namespace ToonyColorsPro
{
    namespace Utilities
    {
        public static class TCP2_GUI
        {
            ...
            private static readonly Dictionary<string, Texture2D> CustomEditorTextures = new();
            ...
            private static readonly Color hoverColor = new(0, 0, 0, 0.05f);
            private static readonly Color hoverColorDark = new(1, 1, 1, 0.05f);
            ...
            public static GUIStyle EnabledPropertyHelpBoxExp
            {
                get
                {
                    if (_EnabledPropertyHelpBoxExp == null)
                    {
                        ...
                        _EnabledPropertyHelpBoxExp.normal.background =
                            GetCustomTexture("TCP2_EnabledBgPropertyExpanded");
                        RectOffset border = _EnabledPropertyHelpBoxExp.border;
                        border.top += 24;
            ...
            public static GUIStyle ErrorPropertyHelpBoxExp
            {
                get
                {
                    if (_ErrorPropertyHelpBoxExp == null)
                    {
                        ...
                        RectOffset border = _ErrorPropertyHelpBoxExp.border;
                        border.top += 24;
            ...
            public static GUIStyle TabError
            {
                get
                {
                    if (_TabError == null)
                    {
                        Color red = EditorGUIUtility.isProSkin
                            ? new Color(0.8f, 0.35f, 0.35f)
                            : new Color(0.7f, 0.1f, 0.1f);
                        Color redFocused = EditorGUIUtility.isProSkin
            ...
            public static GUIStyle ShurikenMiniButton
            {
                get
                {
                    if (_ShurikenMiniButton == null)
                        _ShurikenMiniButton = ShurikenMiniButtonBorder(EditorStyles.miniButton);
            ...
            public static GUIStyle ShurikenMiniButtonLeft
            {
                get
                {
                    if (_ShurikenMiniButtonLeft == null)
                        _ShurikenMiniButtonLeft = ShurikenMiniButtonBorder(EditorStyles.miniButtonLeft);
            ...
            public static GUIStyle ShurikenMiniButtonMid
            {
                get
                {
                    if (_ShurikenMiniButtonMid == null)
                        _ShurikenMiniButtonMid = ShurikenMiniButtonBorder(EditorStyles.miniButtonMid);
            ...
            public static GUIStyle ShurikenMiniButtonRight
            {
                get
                {
                    if (_ShurikenMiniButtonRight == null)
                        _ShurikenMiniButtonRight = ShurikenMiniButtonBorder(EditorStyles.miniButtonRight);
            ...
            private static GUIStyle HeaderLabel => SGUILayout.Styles.OrangeBoldLabel;
            ...
            public static GUIStyle HeaderDropDown
            {
                get
                {
                    if (_HeaderDropDown == null)
                    {
                        ...
                        float gray1 = EditorGUIUtility.isProSkin ? 0.8f : 0.0f;
                        float gray2 = EditorGUIUtility.isProSkin ? 0.65f : 0.3f;

                        Color textColor = new(gray1, gray1, gray1);
                        Color textColorActive = new(gray2, gray2, gray2);
            ...
            public static GUIStyle HeaderDropDownBold
            {
                get
                {
                    if (_HeaderDropDownBold == null)
                    {
                        ...
                        float gray1 = EditorGUIUtility.isProSkin ? 0.7f : 0.3f;
                        float gray2 = EditorGUIUtility.isProSkin ? 0.6f : 0.45f;
            ...
            public static GUIStyle HeaderDropDownBoldGray
            {
                get
                {
                    if (_HeaderDropDownBoldGray == null)
                    {
                        ...
                        float gray1 = EditorGUIUtility.isProSkin ? 0.5f : 0.35f;
                        float gray2 = EditorGUIUtility.isProSkin ? 0.4f : 0.45f;
                        Color textColor = new(gray1, gray1, gray1);
                        Color textColorActive = new(gray2, gray2, gray2);
            ...
            public static Texture2D LayersIconTexture
            {
                get
                {
                    if (_LayersIconTexture == null) _LayersIconTexture = GetCustomTexture("TCP2_LayerIcon");
                    return _LayersIconTexture;
                }
            }

            private static Color HoverColor => EditorGUIUtility.isProSkin ? hoverColorDark : hoverColor;
            ...
            {
                string uiName = name + (EditorGUIUtility.isProSkin ? "pro" : "");
                ...
                if (EditorGUIUtility.isProSkin)
                    texture = AssetDatabase.LoadAssetAtPath(rootPath + "/Editor/Icons/" + name + "_Pro.png",
                        typeof(Texture2D)) as Texture2D;

                //load default version
                if (texture == null)
                    texture = AssetDatabase.LoadAssetAtPath(rootPath + "/Editor/Icons/" + name + ".png",
                        typeof(Texture2D)) as Texture2D;
            ...
            private static GUIStyle ShurikenMiniButtonBorder(GUIStyle source)
            {
            ...
            )
            {
                ...
                if (mouseRect.Contains(Event.current.mousePosition)) EditorGUI.DrawRect(rect, HoverColor);
            }
            ...
            public static void OpenHelpFor(string helpTopic)
            {
                ...
                {
                    string helpAnchor =
                        helpTopic.Replace("/", "_").Replace(@"\", "_").Replace(" ", "_").ToLowerInvariant() + ".htm";
                    string topicFile = rootDir.Replace(@"\", "/") + "/Documentation/Documentation Data/Anchors/" +
                                       helpAnchor;
            ...
            {
                Color colorDark = EditorGUIUtility.isProSkin ? new Color(.1f, .1f, .1f) : new Color(.3f, .3f, .3f);
                Color colorBright = EditorGUIUtility.isProSkin ? new Color(.3f, .3f, .3f) : new Color(.9f, .9f, .9f);
            ...
            {
                if (tooltip != null)
                    EditorGUILayout.LabelField(TempContent(header, tooltip), HeaderLabel,
            ...
            public static bool HeaderFoldout(bool foldout, GUIContent guiContent, bool drawHover = false)
            {
                Rect position = GUILayoutUtility.GetRect(EditorGUIUtility.fieldWidth, EditorGUIUtility.fieldWidth,
                    EditorGUIUtility.singleLineHeight, EditorGUIUtility.singleLineHeight, HeaderDropDownBold);
                if (drawHover) DrawHoverRect(position);
            ...
            public static bool HeaderFoldoutHighlight(Rect position, bool foldout, GUIContent guiContent,
                bool highlighted)
            {
                if (highlighted)
                {
                    Color highlightColor = EditorGUIUtility.isProSkin
                        ? new Color(0.0f, 0.574f, 0.488f, 0.2f)
                        : new Color(0.0f, 0.5f, 0.4f, 0.2f);
            ...
            public static bool HeaderFoldoutHighlightErrorGray(bool foldout, GUIContent guiContent, bool error,
                bool highlighted)
            {
                Rect position = GUILayoutUtility.GetRect(EditorGUIUtility.fieldWidth, EditorGUIUtility.fieldWidth,
                    EditorGUIUtility.singleLineHeight, EditorGUIUtility.singleLineHeight, HeaderDropDownBold);
            ...
            public static bool HeaderFoldoutHighlightErrorGrayPosition(Rect position, bool foldout,
                GUIContent guiContent, bool error, bool highlighted)
            {
                if (error)
                {
                    Color highlightColor = EditorGUIUtility.isProSkin
                        ? new Color(0.85f, 0.1f, 0, 0.2f)
                        : new Color(0.8f, 0, 0, 0.2f);
                    EditorGUI.DrawRect(position, highlightColor);
                }
                else if (highlighted)
                {
            ...
            {
                if (tooltip != null)
                    EditorGUILayout.LabelField(TempContent(header, tooltip), SubHeaderLabel,
                        GUILayout.ExpandWidth(expandWidth));
                else
            ...
            public static void HeaderAndHelp(string header, string tooltip, string helpTopic, GUIStyle style = null)
            {
                ...
                Rect r = GUILayoutUtility.GetRect(TempContent(header, tooltip), EditorStyles.label,
            ...
            {
                if (tooltip != null)
                    GUILayout.Label(TempContent(header, tooltip), highlight ? EnabledLabel : EditorStyles.label,
            ...
            {
                EditorGUI.LabelField(position, GUIContent.none, TempContent(message, GetHelpBoxIcon(msgType)),
                    HelpBoxRichTextStyle);
            }

            public static void HelpBoxLayout(string message, MessageType msgType)
            {
                GUIContent guiContent = TempContent(message, GetHelpBoxIcon(msgType));
            ...
            {
                GUIStyle style = canHover ? ContextualHelpBoxHover : ContextualHelpBox;
                Font globalFont = GUI.skin.font;
                GUI.skin.font = null;
                int indentLevel = EditorGUI.indentLevel;
                EditorGUI.indentLevel = 0;
                EditorGUILayout.LabelField(GUIContent.none, TempContent(message, GetCustomTexture("TCP2_ContextIcon")),
                    style);
            ...
            public static int RadioChoice(int choice, bool horizontal, params string[] labels)
            {
                ...
                for (int i = 0; i < guiContents.Length; i++) guiContents[i] = new GUIContent(labels[i]);
            ...
            public static int RadioChoiceHorizontal(Rect position, int choice, params GUIContent[] labels)
            {
                for (int i = 0; i < labels.Length; i++)
                {
                    ...
                    if (GUI.Toggle(rI, choice == i, labels[i],
                            ...
                            EditorStyles.miniButtonMid)) choice = i;
                }
        ...
        public class TCP2HelpBoxDecorator : MaterialPropertyDrawer
        {
            ...
            {
                position.height -= 4f;
                EditorGUI.LabelField(position, GUIContent.none, new GUIContent(message, icon),
            ...
            public override float GetPropertyHeight(MaterialProperty prop, string label, MaterialEditor editor)
            {
                ...
                float height = TCP2_GUI.HelpBoxRichTextStyle.CalcHeight(new GUIContent(message, icon),
        ...
        public class TCP2OutlineNormalsGUIDrawer : MaterialPropertyDrawer
        {
            ...
            public override void OnGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor)
            {
                TCP2_GUI.Header("Outline Normals Source",
            ...
            {
                string label = prop.targets.Length > 1
        ...
        public class TCP2Vector4FloatsDrawer : MaterialPropertyDrawer
        {
            ...
            private readonly bool useSlider;
            ...
            public TCP2Vector4FloatsDrawer(string labelX, string labelY, string labelZ, string labelW, float minX,
                float maxX, float minY, float maxY, float minZ, float maxZ, float minW, float maxW)
            {
                labels = new[] { labelX, labelY, labelZ, labelW };
            ...
            public override void OnGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor)
            {
                ...
                Vector4 values = prop.vectorValue;
                EditorGUI.BeginChangeCheck();
        ...
        public class TCP2Vector3FloatsDrawer : TCP2Vector4FloatsDrawer
        {
            ...
            public TCP2Vector3FloatsDrawer(string labelX, string labelY, string labelZ, float minX, float maxX,
        ...
        {
            private readonly bool forceHdr;
        ...
        public class TCP2GradientDrawer : MaterialPropertyDrawer
        {
            ...
            private static readonly GUIContent editButtonLabel =
                new("Edit Gradient", "Edit the ramp texture using Unity's gradient editor");

            private static readonly GUIContent editButtonDisabledLabel = new("Edit Gradient",
            ...
            public override void OnGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor)
            {
                ...
                Texture newTexture =
                    (Texture)EditorGUI.ObjectField(position, prop.textureValue, typeof(Texture2D), false);
                ...
                Rect previewRect = new(position.x + indent, position.y + 1, position.width - indent - 19,
                    position.height - 2);
                ...
                {
                    string lastSavePath = GradientManager.LAST_SAVE_PATH;
                    if (!lastSavePath.Contains(Application.dataPath))
                        lastSavePath = Application.dataPath;

                    string path = EditorUtility.SaveFilePanel("Create New Ramp Texture", lastSavePath,
                        "TCP2_CustomRamp", "png");
        ...
        internal class TCP2ToggleNoKeywordDrawer : MaterialPropertyDrawer
        {
            ...
            public override void OnGUI(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
            {
                if (!IsPropertyTypeSuitable(prop))
                {
                    EditorGUI.HelpBox(position, "Toggle used on a non-float property: " + prop.name,
                        MessageType.Warning);
                }
                else
                {
        ...
        internal class TCP2HeaderToggleDrawer : MaterialPropertyDrawer
        {
            ...
            public override float GetPropertyHeight(MaterialProperty prop, string label, MaterialEditor editor)
            {
                if (!IsPropertyTypeSuitable(prop)) return 40f;
        ...
        internal class TCP2MaterialKeywordEnumNoPrefixDrawer : MaterialPropertyDrawer
        {
            ...
            public TCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2) : this(
                new[] { lbl1, lbl2 }, new[] { kw1, kw2 })
            {
            }

            public TCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3,
                string kw3) : this(new[] { lbl1, lbl2, lbl3 }, new[] { kw1, kw2, kw3 })
            {
            }

            public TCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3,
                string kw3, string lbl4, string kw4) : this(new[] { lbl1, lbl2, lbl3, lbl4 },
                new[] { kw1, kw2, kw3, kw4 })
            {
            }
            ...
            public TCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3,
                string kw3, string lbl4, string kw4, string lbl5, string kw5, string lbl6, string kw6, string lbl7,
                string kw7) : this(new[] { lbl1, lbl2, lbl3, lbl4, lbl5, lbl6, lbl7 },
                new[] { kw1, kw2, kw3, kw4, kw5, kw6, kw7 })
            {
            }

            public TCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3,
                string kw3, string lbl4, string kw4, string lbl5, string kw5, string lbl6, string kw6, string lbl7,
                string kw7, string lbl8, string kw8) : this(new[] { lbl1, lbl2, lbl3, lbl4, lbl5, lbl6, lbl7, lbl8 },
                new[] { kw1, kw2, kw3, kw4, kw5, kw6, kw7, kw8 })
            {
            }
        ...
        internal class MaterialTCP2EnumDrawer : MaterialPropertyDrawer
        {
            ...
            public MaterialTCP2EnumDrawer(string n1, float v1) : this(new[] { n1 }, new[] { v1 })
            {
            }

            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2) : this(new[] { n1, n2 },
                new[] { v1, v2 })
            {
            }

            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3) : this(
                new[] { n1, n2, n3 }, new[] { v1, v2, v3 })
            {
            }

            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4) : this(new[] { n1, n2, n3, n4 }, new[] { v1, v2, v3, v4 })
            {
            }

            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5) : this(new[] { n1, n2, n3, n4, n5 }, new[] { v1, v2, v3, v4, v5 })
            {
            }

            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6) : this(new[] { n1, n2, n3, n4, n5, n6 },
                new[] { v1, v2, v3, v4, v5, v6 })
            {
            }

            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6, string n7, float v7) : this(
                new[] { n1, n2, n3, n4, n5, n6, n7 }, new[] { v1, v2, v3, v4, v5, v6, v7 })
            {
            }

            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8) : this(
                new[] { n1, n2, n3, n4, n5, n6, n7, n8 }, new[] { v1, v2, v3, v4, v5, v6, v7, v8 })
            {
            }

            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8, string n9,
                float v9) : this(new[] { n1, n2, n3, n4, n5, n6, n7, n8, n9 },
            ...
            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8, string n9,
                float v9, string n10, float v10) : this(new[] { n1, n2, n3, n4, n5, n6, n7, n8, n9, n10 },
                new[] { v1, v2, v3, v4, v5, v6, v7, v8, v9, v10 })
            {
            }

            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8, string n9,
                float v9, string n10, float v10, string n11, float v11) : this(
                new[] { n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11 },
            ...
            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8, string n9,
                float v9, string n10, float v10, string n11, float v11, string n12, float v12) : this(
                new[] { n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12 },
                new[] { v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12 })
            {
            }

            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8, string n9,
                float v9, string n10, float v10, string n11, float v11, string n12, float v12, string n13,
                float v13) : this(new[] { n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13 },
            ...
            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8, string n9,
                float v9, string n10, float v10, string n11, float v11, string n12, float v12, string n13, float v13,
                string n14, float v14) : this(new[] { n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14 },
                new[] { v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14 })
            {
            }
            ...
            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8, string n9,
                float v9, string n10, float v10, string n11, float v11, string n12, float v12, string n13, float v13,
                string n14, float v14, string n15, float v15) : this(
                new[] { n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n15 },
                new[] { v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 })
            {
            }
            ...
            public MaterialTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4,
                float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8, string n9,
                float v9, string n10, float v10, string n11, float v11, string n12, float v12, string n13, float v13,
                string n14, float v14, string n15, float v15, string n16, float v16) : this(
                new[] { n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n15, n16 },
                new[] { v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16 })
            {
            }
            ...
            public MaterialTCP2EnumDrawer(string[] enumNames, float[] vals)
            {
                ...
                for (int i = 0; i < enumNames.Length; i++) names[i] = new GUIContent(enumNames[i]);
                values = new float[vals.Length];
                for (int j = 0; j < vals.Length; j++) values[j] = vals[j];
            }
            ...
            public override void OnGUI(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
            {
                ...
                else
                {
                    ...
                    EditorGUI.showMixedValue = false;
                    if (EditorGUI.EndChangeCheck()) prop.floatValue = values[num2];
                }
            }
        }
        ...
        {
            private static readonly GUIContent[] s_UVLabels =
            {
                new("U"),
                new("V")
            };

            private static readonly float[] s_UVValues =
            {
                0,
                0
            };
