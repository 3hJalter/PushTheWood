...
namespace ToonyColorsPro
{
    namespace ShaderGenerator
    {
        internal static class SGUILayout
        {
            ...
            private static readonly string XYZOptions = "XYZ";

            private static readonly int foldoutHash = "TCP2 Foldout".GetHashCode();

            private static readonly List<char> ValidVariableCharacters =
                new("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_0123456789".ToCharArray());
            ...
            {
                char upperCurrent = char.ToUpperInvariant(current);
                int selected = options.IndexOf(upperCurrent);
 ...
 (i == 0) ? TCP2_GUI.ShurikenMiniButtonLeft : (i == (options.Length-1) ? TCP2_GUI.ShurikenMiniButtonRight : TCP2_GUI.ShurikenMiniButtonMid);
#else
                    Rect rect = GetControlRect(Styles.ShurikenMiniButtonCustom, width: w);
                    GUIStyle style = Styles.ShurikenMiniButtonCustom;
#endif

                    if (GUI.Toggle(rect, selected == i, options[i].ToString(), style)) selected = i;
                }
                ...
                bool showAvailableChannels = true)
            {
                ...
                string newSelected = EditorGUI.DelayedTextField(rect, selected, Styles.ShurikenValue);
                if (EditorGUI.EndChangeCheck())
                {
                    // empty string
                    if (newSelected.Length == 0) return selected;
            ...
            public static bool Foldout(bool foldout, GUIContent label, bool highlighted = false, float width = 130)
            {
                ...
                Rect rect = GUILayoutUtility.GetRect(label,
                ...
                if (hover) EditorGUI.DrawRect(rect, Color.black * 0.1f);
            ...
            {
                GUILayout.Space(Indent);
                Rect rect = GUILayoutUtility.GetRect(label, Styles.GrayMiniBoldLabel);
                rect.y -= 2;
            ...
            {
                GUIStyle style = monospace ? Styles.ShurikenValueMonospace : Styles.ShurikenValue;
                if (delayed)
            ...
            public static string TextFieldShaderVariable(Rect rect, string str)
            {
                ...
                string result = TextField(rect, str, monospace: true);
            ...
            {
                GUIStyle style = monospace ? Styles.ShurikenTextAreaMonospace : Styles.ShurikenTextArea;
                return height > 0
            ...
            public static T DrawProObjectField<T>(T obj, params GUILayoutOption[] options) where T : Object
            {
                ...
                Rect rect = EditorGUILayout.GetControlRect(false, Styles.shurikenLineHeight, Styles.ShurikenValue,
                    options);
                Rect btnRect = rect;
                btnRect.width = 20;
            ...
            {
                return GUILayout.Button(content, Styles.ShurikenPopup, GUILayout.MinWidth(248),
            ...
            {
                Rect rect = EditorGUILayout.GetControlRect(false, Styles.shurikenLineHeight, Styles.ShurikenToggle,
            ...
            {
                Rect rect = GUILayoutUtility.GetRect(GUIContent.none, Styles.LineStyle, GUILayout.Height(1));
            ...
            public static void DrawLockIcon(Color color)
            {
                if (gcInspectorLock != null)
                {
                    Color c = GUI.color;
                    GUI.color *= color;
                    Rect lockIconRect = EditorGUILayout.GetControlRect(false, 14, GUILayout.Width(14));
            ...
            internal static class Styles
            {
                ...
                internal static GUIStyle GrayLabel
                {
                    get
                    {
                        if (_GrayLabel == null)
                        {
                            Color32 color = EditorGUIUtility.isProSkin
                ...
                internal static Color OrangeColor => EditorGUIUtility.isProSkin
                    ? new Color32(250, 130, 0, 255)
                    : new Color32(200, 100, 20, 255);
                ...
                private static GUIStyle _OrangeHeader;
                ...
                private static GUIStyle _GrayBoldLabel;
                ...
                internal static GUIStyle GrayMiniLabel
                {
                    get
                    {
                        if (_GrayMiniLabel == null)
                        {
                            ...
                            float c = EditorGUIUtility.isProSkin ? .7f : .3f;
                ...
                public static GUIStyle GrayMiniFoldout
                {
                    get
                    {
                        if (_GrayMiniFoldout == null)
                        {
                            ...
                            GUIStyle grayMiniLabel = GrayMiniLabel;
                            ...
                            float gray = EditorGUIUtility.isProSkin ? 0.4f : 0.45f;
                            Color textColorActive = new Color(gray, gray, gray);
                ...
                private const int shurikenFontSize = 10;
                ...
                private static GUIStyle _ShurikenValueMonospace;
                ...
                internal static GUIStyle ShurikenValueMonospace
                {
                    get
                    {
                        if (_ShurikenValueMonospace == null)
                        {
                            ...
                            Font robotoMonospace =
                                AssetDatabase.LoadAssetAtPath<Font>(
                                    AssetDatabase.GUIDToAssetPath("64bf6567ab0269a47bfa164e4156cc4f"));
                            if (robotoMonospace != null) _ShurikenValueMonospace.font = robotoMonospace;
                        }
                ...
                private static GUIStyle _ShurikenTextAreaMonospace;
                ...
                internal static GUIStyle ShurikenTextAreaMonospace
                {
                    get
                    {
                        ...
                        Font robotoMonospace =
                            AssetDatabase.LoadAssetAtPath<Font>(
                                AssetDatabase.GUIDToAssetPath("64bf6567ab0269a47bfa164e4156cc4f"));
                        if (robotoMonospace != null) _ShurikenTextAreaMonospace.font = robotoMonospace;
                ...
                private static GUIStyle _ShurikenMiniButtonCustom;
                ...
                internal static GUIStyle ShurikenMiniButtonCustom
                {
                    get
                    {
                        if (_ShurikenMiniButtonCustom == null)
                        {
                            ...
                            RectOffset margin = _ShurikenMiniButtonCustom.margin;
                            margin.top -= 3;
                ...
                private static GUIStyle _ShurikenMiniButtonFlexible;
...
#if UNITY_2019_3_OR_NEWER
                private const int MINI_BUTTON_FONT_SIZE = 10;
#endif
                    ...
                    get
                    {
                        ...
                        if (_MiniButtonLeft == null)
                            _MiniButtonLeft = new GUIStyle(EditorStyles.miniButtonLeft)
                                { fontSize = MINI_BUTTON_FONT_SIZE };
