...
public class TCP2_MaterialInspector : ShaderGUI
{
    ...
    //Shader Variants 
    private readonly List<string> ShaderVariants = new()
    {
        "Specular",
        "Reflection",
        "Matcap",
    ...
    private readonly List<bool> ShaderVariantsEnabled = new()
    {
        false,
        false,
        false,
    ...
    public override void AssignNewShaderToMaterial(Material material, Shader oldShader, Shader newShader)
    {
        ...
        ShaderImporter shaderImporter =
            AssetImporter.GetAtPath(AssetDatabase.GetAssetPath(newShader)) as ShaderImporter;
        ...
        if (materialEditor.isVisible && !mShader.hasMultipleDifferentValues && mShader.objectReferenceValue != null)
        {
            ...
            if (ShowFilteredProperties(null, props))
            {
                if (!isGeneratedShader)
                    Utils.ShaderKeywordToggle("TCP2_DISABLE_WRAPPED_LIGHT", "Disable Wrapped Lighting",
            ...
            if (CategoryFilter("TEXTURE_RAMP"))
            {
                ...
                {
                    if (Utils.ShaderKeywordToggle("TCP2_RAMPTEXT", "Texture Toon Ramp",
            ...
            if (CategoryFilter("BUMP"))
            {
                ...
                {
                    if (Utils.ShaderKeywordToggle("TCP2_BUMP", "BUMP/NORMAL MAPPING",
            ...
            if (CategoryFilter("SPECULAR", "SPECULAR_ANISOTROPIC"))
            {
                ...
                {
                    bool specular = Utils.HasKeywords(keywordsList, "TCP2_SPEC", "TCP2_SPEC_TOON");
                    Utils.ShaderVariantUpdate("Specular", ShaderVariants, ShaderVariantsEnabled, specular,
                        ref updateVariant);

                    specular |= Utils.ShaderKeywordRadio("SPECULAR",
                    ...
                    if (specular)
                    {
                        ...
                        bool specr = Utils.HasKeywords(keywordsList, "TCP2_SPEC_TOON");
            ...
            if (CategoryFilter("REFLECTION") && !isMobileShader)
            {
                ...
                {
                    bool reflection = Utils.HasKeywords(keywordsList, "TCP2_REFLECTION", "TCP2_REFLECTION_MASKED");
                    Utils.ShaderVariantUpdate("Reflection", ShaderVariants, ShaderVariantsEnabled, reflection,
                        ref updateVariant);

                    reflection |= Utils.ShaderKeywordRadio("REFLECTION",
            ...
            if (CategoryFilter("MATCAP"))
            {
                ...
                {
                    bool matcap = Utils.HasKeywords(keywordsList, "TCP2_MC", "TCP2_MCMASK");
                    Utils.ShaderVariantUpdate("Matcap", ShaderVariants, ShaderVariantsEnabled, matcap,
                        ref updateVariant);

                    matcap |= Utils.ShaderKeywordRadio("MATCAP", new[] { "TCP2_MC_OFF", "TCP2_MC", "TCP2_MCMASK" },
                        new[]
                        {
            ...
            if (CategoryFilter("RIM", "RIM_OUTLINE"))
            {
                ...
                {
                    bool rim = Utils.HasKeywords(keywordsList, "TCP2_RIM");
                    bool rimOutline = Utils.HasKeywords(keywordsList, "TCP2_RIMO");

                    Utils.ShaderVariantUpdate("Rim", ShaderVariants, ShaderVariantsEnabled, rim, ref updateVariant);
                    Utils.ShaderVariantUpdate("RimOutline", ShaderVariants, ShaderVariantsEnabled, rimOutline,
                        ref updateVariant);

                    rim |= rimOutline |= Utils.ShaderKeywordRadio("RIM",
                    ...
                    if (rim || rimOutline)
                    {
                        ...
                        if (CategoryFilter("RIMDIR"))
                            if (Utils.ShaderKeywordToggle("TCP2_RIMDIR", "Directional Rim",
            ...
            if (CategoryFilter("OUTLINE", "OUTLINE_BLENDING"))
            {
                ...
                else
                {
                    ...
                    Utils.ShaderVariantUpdate("Outline", ShaderVariants, ShaderVariantsEnabled, hasOutlineOpaque,
                        ref updateVariant);
                    Utils.ShaderVariantUpdate("OutlineBlending", ShaderVariants, ShaderVariantsEnabled,
                        hasOutlineBlending, ref updateVariant);

                    hasOutline |= Utils.ShaderKeywordRadio("OUTLINE",
                ...
                if (hasOutline)
                {
                    ...
                    {
                        bool outlineTextured = Utils.ShaderKeywordToggle("TCP2_OUTLINE_TEXTURED",
                    ...
                    Utils.ShaderKeywordToggle("TCP2_OUTLINE_CONST_SIZE", "Constant Size Outline",
                        "If enabled, outline will have a constant size independently from camera distance",
                        keywordsList, ref updateKeywords);
                    if (Utils.ShaderKeywordToggle("TCP2_ZSMOOTH_ON", "Correct Z Artefacts",
                    ...
                    if (hasOutlineBlending)
                    {
                        ...
                        else
                        {
                            ...
                            BlendMode blendSrc = (BlendMode)blendProps[0].floatValue;
                            BlendMode blendDst = (BlendMode)blendProps[1].floatValue;
