    ...
    namespace Demo
    {
        public class TCP2_Demo_Camera : MonoBehaviour
        {
            ...
            private void Update()
            {
                ...
                bool ignoreMouse = ignoreMouseRect != null
                    ? ignoreMouseActualRect.Contains(Input.mousePosition)
                    : false;
                ...
                {
                    float str = Mathf.Lerp(PanStrgMin, PanStrgMax,
            ...
            private void OnEnable()
            {
                ...
                Rect rect = new(ignoreMouseRect.position.x, ignoreMouseRect.position.y, size.x, size.y);
