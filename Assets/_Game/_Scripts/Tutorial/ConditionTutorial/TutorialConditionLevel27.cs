...
{
    [CreateAssetMenu(fileName = "TutorialLevel27", menuName = "ScriptableObjects/TutorialData/Lvl27", order = 1)]
    public class TutorialConditionLevel27 : BaseTutorialData, ITutorialCondition
    {
        public void HandleShowTutorial(GameGridCell cell, GridUnit triggerUnit)
        {
            if (currentTutIndex == 0)
            {
                ...
                // if Player at cell 7, 9 -> Change to Cell that Player init in level 27
