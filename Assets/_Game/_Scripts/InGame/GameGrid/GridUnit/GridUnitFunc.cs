...
namespace _Game.GameGrid.GridUnit
{
    public static class GridUnitFunc
    {
        ...
        {
            return GameGridManager.Ins.GetNeighbourCell(unit.MainCell, direction);
        }
        ...
        public static HashSet<GameGridCell> GetNextCells(GridUnit unit, Direction direction)
        {
            ...
            {
                GameGridCell nextCell = GameGridManager.Ins.GetNeighbourCell(unit.cellInUnits[i], direction);
