...
namespace Sirenix.OdinInspector.Modules.UnityMathematics.Editor
{
    ...
    public class Bool2Drawer : OdinValueDrawer<bool2>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            {
                bool showLabels = !isMatrixChild && SirenixEditorFields.ResponsiveVectorComponentFields &&
                                  contentRect.width >= 100;

                if (label != null) GUILayout.Space(3); // Ugh, better than nothing

                GUILayoutOptions.GUILayoutOptionsInstance options =
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            Rect contentRect = SirenixEditorGUI.BeginHorizontalPropertyLayout(label, out labelRect);
            {
                // Slide rect
                {
                    ...
                    EditorGUI.BeginChangeCheck();
                    Vector4 vec =
                        SirenixEditorFields.VectorPrefixSlideRect(labelRect, new Vector3(val.x, val.y, val.z));
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            Rect contentRect = SirenixEditorGUI.BeginHorizontalPropertyLayout(label, out labelRect);
            {
                // Slide rect
                {
                    ...
                    EditorGUI.BeginChangeCheck();
                    Vector4 vec =
                        SirenixEditorFields.VectorPrefixSlideRect(labelRect, new Vector4(val.x, val.y, val.z, val.w));
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            Rect contentRect = SirenixEditorGUI.BeginHorizontalPropertyLayout(label, out labelRect);
            {
                // Slide rect
                {
                    ...
                    EditorGUI.BeginChangeCheck();
                    Vector4 vec =
                        SirenixEditorFields.VectorPrefixSlideRect(labelRect, new Vector2((float)val.x, (float)val.y));
