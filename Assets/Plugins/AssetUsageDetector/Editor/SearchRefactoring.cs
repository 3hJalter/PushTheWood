...
namespace AssetUsageDetectorNamespace
{
    ...
    public abstract class GenericSearchMatch : SearchMatch
    {
        ...
        internal GenericSearchMatch(object source, Object value, Object context, SetterFunction setter) : base(source,
            value, context)
        {
            Setter = setter;
        }
    ...
    public class SerializedPropertyMatch : SearchMatch
    {
        public readonly SerializedProperty
            SerializedProperty; // Next or NextVisible mustn't be called with this SerializedProperty
    ...
    public class AssetImporterDefaultValueMatch : SearchMatch
    {
        ...
        internal AssetImporterDefaultValueMatch(Object source, Object value, string variable,
            VariableGetterHolder[] monoScriptAllVariables) : base(source, value)
        {
            Variable = variable;
        ...
        protected override bool ChangeValue(Object newValue, out bool setContextDirty)
        {
            ...
            if (Source is MonoImporter)
            {
                ...
                List<string> variableNames = new(8);
                List<Object> variableValues = new(8);
            ...
            else if (Source is ShaderImporter)
            {
                ...
                List<string> textureNames = new(16);
                List<Texture> textureValues = new(16);
#if UNITY_2018_1_OR_NEWER
                List<string> nonModifiableTextureNames = new(16);
                List<Texture> nonModifiableTextureValues = new(16);
#endif
...
#if UNITY_2018_1_OR_NEWER
                shaderImporter.SetNonModifiableTextures(nonModifiableTextureNames.ToArray(),
    ...
    public class AnimationSystemMatch : GenericSearchMatch
    {
        ...
        internal AnimationSystemMatch(object source, Object value, Object context, SetterFunction setter) : base(source,
    ...
    public class OtherSearchMatch : GenericSearchMatch
    {
        ...
        internal OtherSearchMatch(object source, Object value, Object context, SetterFunction setter) : base(source,
            value, context, setter)
        {
        }
    }
