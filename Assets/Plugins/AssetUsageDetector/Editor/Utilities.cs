...
namespace AssetUsageDetectorNamespace
{
    public static class Utilities
    {
        ...
        {
            string[] folderContents = AssetDatabase.FindAssets("", new[] { AssetDatabase.GetAssetPath(folderAsset) });
        ...
        public static void GetObjectsToSelectAndPing(this Object obj, out Object selection, out Object pingTarget)
        {
            ...
            if (obj.IsAsset())
            {
...
#endif
                        {
                            GameObject prefabStageGO = FollowSymmetricHierarchy((GameObject)obj,
                                ((GameObject)obj).transform.root.gameObject, openPrefabStage.prefabContentsRoot);
                ...
                else if (!AssetDatabase.IsMainAsset(obj) &&
                         Array.IndexOf(AssetDatabase.LoadAllAssetRepresentationsAtPath(AssetDatabase.GetAssetPath(obj)),
                             obj) < 0)
                {
        ...
        public static GameObject FollowSymmetricHierarchy(this GameObject go, GameObject thisRoot,
            GameObject symmetricRoot)
        {
        ...
        public static VariableGetVal CreateGetter(this PropertyInfo propertyInfo)
        {
            ...
            Type GenType =
                typeof(PropertyWrapper<,>).MakeGenericType(propertyInfo.DeclaringType, propertyInfo.PropertyType);
